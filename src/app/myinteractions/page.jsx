      ...
      {interactions.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {interactions.map((item) => (
            <Link
              href={`/ideadetails/${item.ideaId}`} // ✅ This redirects to idea details page
              key={item.ideaId}
            >
              <div className="bg-white dark:bg-gray-900 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-200 dark:border-gray-800 hover:scale-[1.02] cursor-pointer">
